 ...
 * pending invitations are reported alongside rather than subtracted. When more are
 * outstanding than seats remain — legitimate under the soft cap, since the limit is
 * enforced at acceptance — the icon turns into a warning and the tooltip says so.
 */
