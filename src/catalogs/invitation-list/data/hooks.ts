...
// Prefix of catalogs/data/hooks `catalogDetail(slug)`. Invalidating the prefix refreshes
// the header seat counts without needing the slug (and without importing wouter).
const catalogDetailQueryKeyBase = [appId, 'catalog.details', 'catalog'];
...
export const useCancelInvitation = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: catalogDetailQueryKeyBase });
    },
  });
};
