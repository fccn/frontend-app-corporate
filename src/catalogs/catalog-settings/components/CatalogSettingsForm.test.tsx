...
describe('CatalogSettingsForm', () => {
  ...
  beforeEach(() => {
    ...
    mockUseCatalogDetails.mockReturnValue({ data: mockCatalog });
    mockUseUpdateCatalog.mockReturnValue({ mutate: jest.fn() });
  });
